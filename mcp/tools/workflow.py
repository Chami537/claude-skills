...
WRAP = [
    ...
    {"action":"auto_update_claude_md","reason":"update CLAUDE.md with latest commit summary and project status"},
    {"action":"auto_save_memory","reason":"save lessons and progress to memory without asking user"},
