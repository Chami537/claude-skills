...
2. **读 patterns** — 调用 `patterns_list("<slug>")`。对每个 pattern：
...
3. **读 Memory** — 读 `~/.claude/projects/C--Users-Rinat/memory/MEMORY.md`，找到匹配项目的 `project_*.md` 和 `feedback_*.md`，逐个用 Read 读
